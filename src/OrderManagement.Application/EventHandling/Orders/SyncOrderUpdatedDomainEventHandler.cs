...
public sealed class SyncOrderUpdatedDomainEventHandler : IDomainEventHandler<OrderUpdatedDomainEvent>
{
    ...
    public SyncOrderUpdatedDomainEventHandler(ICustomerWriteRepository customers,
    ...
    public async Task Handle(OrderUpdatedDomainEvent notification, CancellationToken cancellationToken)
    {
        ...
        await _orders.SyncOrderUpdatedAsync(model, cancellationToken);
    }
}